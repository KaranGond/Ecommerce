                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7x1 lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-xl font-semibold text-text-900">UniversalOutFit</h1>
                            <h1 className='text-lg lg:text-xl text-grey-900 opacity-60 pt-1'>Universal goes here.</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className='flex space-x-5 item-center text-lg lg:text-xl text-grey-900 mt-6'>
                            ...
                            <form className="mt-10">
                                ...
                                <Button onClick={handleAddToCart}variant="contained" sx={{ px: "2rem", py: "1rem", backgroundColor: "#9155fd" }}>
                                    Add to Cart
                                </Button>
                            </form>
                        </div>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>5966 Ratings</p>
                                </div>
                ...
                <section className="pt-10 flex flex-col items-center justify-center">
                    ...
                    <div className="flex flex-wrap space-y-5">
                        {mens_kurta.map((item, index) => (
                            <HomeSectionCards key={index} product={item} />
                        ))}
                    </div>
                </section>
